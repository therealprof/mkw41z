...
#[doc = r" Proxy"]
pub struct _TX_PKT_LENGTHW<'a> {
    w: &'a mut W,
}
impl<'a> _TX_PKT_LENGTHW<'a> {
    #[doc = r" Writes raw bits to the field"]
    #[inline]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
        const MASK: u8 = 63;
...
#[doc = r" Proxy"]
pub struct _RX_PKT_LENGTHW<'a> {
    w: &'a mut W,
}
impl<'a> _RX_PKT_LENGTHW<'a> {
    #[doc = r" Writes raw bits to the field"]
    #[inline]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
        const MASK: u8 = 63;
...
impl R {
    ...
    #[doc = "Bits 8:13 - Transmit Packet Length"]
    #[inline]
    pub fn tx_pkt_length(&self) -> TX_PKT_LENGTHR {
        let bits = {
            const MASK: u8 = 63;
            const OFFSET: u8 = 8;
            ((self.bits >> OFFSET) & MASK as u32) as u8
    ...
    #[doc = "Bits 16:21 - Receive Packet Length"]
    #[inline]
    pub fn rx_pkt_length(&self) -> RX_PKT_LENGTHR {
        let bits = {
            const MASK: u8 = 63;
            const OFFSET: u8 = 16;
            ((self.bits >> OFFSET) & MASK as u32) as u8
...
impl W {
    ...
    #[doc = "Bits 8:13 - Transmit Packet Length"]
    #[inline]
    pub fn tx_pkt_length(&mut self) -> _TX_PKT_LENGTHW {
        _TX_PKT_LENGTHW { w: self }
    }
    #[doc = "Bits 16:21 - Receive Packet Length"]
    #[inline]
    pub fn rx_pkt_length(&mut self) -> _RX_PKT_LENGTHW {
        _RX_PKT_LENGTHW { w: self }
    }
}
