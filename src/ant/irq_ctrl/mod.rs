...
#[doc = "Possible values of the field `ANT_IRQ_EN`"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum ANT_IRQ_ENR {
    #[doc = "All ANT Interrupts are disabled."]
    _0,
    #[doc = "All ANT Interrupts can be enabled."]
    _1,
}
impl ANT_IRQ_ENR {
    #[doc = r" Returns `true` if the bit is clear (0)"]
    ...
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: bool) -> ANT_IRQ_ENR {
        match value {
            false => ANT_IRQ_ENR::_0,
            true => ANT_IRQ_ENR::_1,
        }
    }
    #[doc = "Checks if the value of the field is `_0`"]
...
#[doc = "Values that can be written to the field `ANT_IRQ_EN`"]
pub enum ANT_IRQ_ENW {
    #[doc = "All ANT Interrupts are disabled."]
    _0,
    #[doc = "All ANT Interrupts can be enabled."]
    _1,
...
impl ANT_IRQ_ENW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            ANT_IRQ_ENW::_0 => false,
            ANT_IRQ_ENW::_1 => true,
        }
    }
}
#[doc = r" Proxy"]
pub struct _ANT_IRQ_ENW<'a> {
    w: &'a mut W,
}
impl<'a> _ANT_IRQ_ENW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: ANT_IRQ_ENW) -> &'a mut W {
        {
            self.bit(variant._bits())
        }
    }
    ...
    #[inline]
    pub fn _0(self) -> &'a mut W {
        self.variant(ANT_IRQ_ENW::_0)
    }
    #[doc = "All ANT Interrupts can be enabled."]
    #[inline]
    pub fn _1(self) -> &'a mut W {
        self.variant(ANT_IRQ_ENW::_1)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl R {
    ...
    #[doc = "Bit 26 - ANT_IRQ Master Enable"]
    #[inline]
    pub fn ant_irq_en(&self) -> ANT_IRQ_ENR {
        ANT_IRQ_ENR::_from({
            const MASK: bool = true;
            const OFFSET: u8 = 26;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
impl W {
    ...
    #[doc = "Bit 26 - ANT_IRQ Master Enable"]
    #[inline]
    pub fn ant_irq_en(&mut self) -> _ANT_IRQ_ENW {
        _ANT_IRQ_ENW { w: self }
    }
    #[doc = "Bit 27 - CRC Ignore"]
    #[inline]
