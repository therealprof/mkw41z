...
impl R {
    ...
    #[doc = "Bit 14 - The current received dataword contained in DATA[R9:R0] was received with a parity error."]
    #[inline]
    ...
    #[doc = "Bit 15 - The current received dataword contained in DATA[R9:R0] was received with noise."]
    #[inline]
